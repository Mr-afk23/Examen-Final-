...
public class PanelProximamente extends JPanel {
    ...
    public PanelProximamente() {
        setLayout(new BorderLayout());

        JLabel lblTitulo = new JLabel("📅 Próximamente", SwingConstants.CENTER);
        lblTitulo.setFont(new Font("Arial", Font.BOLD, 22));
        add(lblTitulo, BorderLayout.NORTH);

        // Lista de películas (cada array: {titulo, genero, duracion, rutaImagen})
        Object[][] proximamente = {
                { "Deadpool", "Acción", "2h10m", "assets/Deapool.jpg" },
                { "Gladiador", "Histórica", "2h35m", "assets/gladiador.jpeg" },
                { "Inside Out", "Animación", "1h50m", "assets/Inside.jpg" },
                { "Sonic", "Aventura", "1h40m", "assets/sonic.jpeg" }
        };
        ...
        for (Object[] pelicula : proximamente) {
    ...
    private JPanel crearCard(String titulo, String genero, String duracion, String rutaImagen) {
        ...
        btnReservar.addActionListener(e -> {
            ...
            Pelicula p = new Pelicula(titulo, genero, duracion, ""); // puedes añadir clasificación si quieres
