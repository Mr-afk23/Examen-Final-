...
public class PanelEstrenos extends JPanel {

    public PanelEstrenos() {
        setLayout(new BorderLayout());

        JLabel lblTitulo = new JLabel("🎬 Estrenos", SwingConstants.CENTER);
        lblTitulo.setFont(new Font("Arial", Font.BOLD, 22));
        add(lblTitulo, BorderLayout.NORTH);

        // Lista de películas estreno {titulo, genero, duracion, rutaImagen}
        Object[][] estrenos = {
                { "Nope", "Terror", "2h10m", "assets/nope.jpeg" },
                { "Black Adam", "Acción", "2h15m", "assets/balckAdam.jpeg" },
                { "Buzz Lightyear", "Animación", "1h50m", "assets/buzz.jpeg" },
                { "Avatar 2", "Aventura", "3h00m", "assets/avatar2.jpeg" }
        };

        JPanel grid = new JPanel(new FlowLayout(FlowLayout.CENTER, 20, 20));

        for (Object[] pelicula : estrenos) {
